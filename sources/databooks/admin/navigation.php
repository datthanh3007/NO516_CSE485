        ...
        <div class="navbar-collapse collapse">
            <ul class="nav navbar-nav">
                ...
                <li <?php echo $page_title=="Admin " ? "class='active'" : ""; ?>>
                    <a href="<?php echo $home_url; ?>admin/index.php">TRANG CHỦ</a>
                </li>
 
                <!-- highlight for user related pages -->
                <li <?php
                        echo $page_title=="Users" ? "class='active'" : ""; ?> >
                    <a href="<?php echo $home_url; ?>admin/read_users.php">THÀNH VIÊN</a>
                </li>
                <li  <?php echo $page_title=="add_data" ? "class='active'" : ""; ?> >
                    <a href="<?php echo $home_url; ?>admin/add_data.php ">THÊM SÁCH </a>
                </li>
            </ul>
            ...
            <ul class="nav navbar-nav navbar-right">
                <li>
                    ...
                    <ul class="dropdown-menu" role="menu">
                        <!-- log out user -->
                        <li><a href="<?php echo $home_url; ?>./user/logout.php">ĐĂNG XUẤT</a></li>
                    </ul>
                </li>
            </ul>
